...
video_set_path = "Data\Videos\PullShotsFlipped"
output_data_path = "Data\poselandmarks\pullshotsflipped"
...
for video in os.listdir(video_set_path):
    ...
    output_file_path = os.path.join(output_data_path, f"pf{vid_index}.npy")
